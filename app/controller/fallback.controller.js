        ...
        if(validation.passes()){
            ...
            if(checkSetting){
                var updateData = {
                    ...
                    url: path.join(req.body.url, '/api/call/make-call')
                }
                ...
                var updateData2 = {
                    ...
                    voice_url: path.join(req.body.url, '/api/call/incomming'),
                    sms_url: path.join(req.body.url, '/api/setting/receive-sms/twilio')
                }
        ...
        if(validation.passes()){
            ...
            if(checkSetting){
                var updateData = {
                    ...
                    url: path.join(req.body.url, '/api/setting/receive-sms/telnyx')
                }
                ...
                var updateData2 = {
                    ...
                    url: path.join(req.body.url, '/api/call/telnyx')
                }
                ...
                var updateData3 = {
                    ...
                    url: path.join(req.body.url, '/api/call/status/telnyx')
                }
